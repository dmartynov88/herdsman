...
namespace Adic.Binding {
    ...
    public class BindingInfo {
        ...
        /// <summary>Is binding supports lazy initialization.</summary>
        ...
        /// <param name="instanceType">Binding instance type.</param>
        /// <param name="originalBinding">Original binding.</param>
        /// <param name="isLazy">Is type needs to support lazy initialization.</param>
        public BindingInfo(Type type, object value, BindingInstance instanceType, BindingInfo originalBinding, bool isLazy = false) {
            this.type = type;
            this.value = value;
            this.instanceType = instanceType;
            this.originalBinding = originalBinding;
        ...
        /// <param name="instanceType">Binding instance type.</param>
        /// <param name="isLazy">Is type needs to support lazy initialization.</param>
        public BindingInfo(Type type, object value, BindingInstance instanceType, bool isLazy) : this(type, value, instanceType, null, isLazy) {
        }
