...
namespace Adic.Binding {
    ...
    public class BindingFactory : IBindingFactory {
        ...
        /// <summary>
        /// Binds the key type for lazy initialization.
        /// </summary>
        /// <returns>The binding condition object related to this binding.</returns>
        public IBindingConditionFactory Lazy()
        {
            return this.AddBinding(this.bindingType, BindingInstance.Singleton, true);
        }
        ...
        /// </summary>
        /// <returns>The binding condition object related to this binding.</returns>
        public IBindingConditionFactory Lazy<T>() where T : class
        {
            return this.AddBinding(typeof(T), BindingInstance.Singleton, true);
        }
        ...
        /// <param name="instanceType">Binding instance type.</param>
        /// <returns>The binding condition factory.</returns>
        public IBindingConditionFactory AddBinding(object value, BindingInstance instanceType, bool isLazy = false) {
            var binding = new BindingInfo(this.bindingType, value, instanceType, isLazy);
            this.binder.AddBinding(binding);
